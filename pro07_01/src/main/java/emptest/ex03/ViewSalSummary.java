...
@WebServlet("/viewsalsummary03")
public class ViewSalSummary extends HttpServlet {
	...
	protected void doHandle(HttpServletRequest request, HttpServletResponse response) 
	    ...
	    List<SalSummaryVO> salSummaryList = 
	    				(List<SalSummaryVO>) request.getAttribute("salSummaryList");
		...
		out.print("</table>"
				+ "</body></html>");
		out.print("<a href='/pro07/salsummary03'>결과 갱신하기</a>");
		out.print("<hr>");
